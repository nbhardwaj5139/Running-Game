...
export function buildPowers() {
  ...
  // rocket: a bō-hiya, the samurai fire-arrow rocket, leaning on its stand with the fuse lit
  const rocket = merge([P(cyl(0.06, 0.06, 0.62, 8), '#2b1d1a', [0, 0.5, 0], [0, 0, -0.35]), P(cyl(0.07, 0.07, 0.2, 8), '#c9302c', [0.1, 0.78, 0], [0, 0, -0.35]),
    P(cone(0.07, 0.18, 8), '#b8b8c0', [0.17, 0.97, 0], [0, 0, -0.35]), P(cyl(0.012, 0.012, 0.45, 5), '#5a4030', [-0.13, 0.15, 0], [0, 0, -0.35]),
    P(box(0.16, 0.02, 0.03), '#e8ecf4', [-0.19, 0.22, 0.03], [0, 0, -0.35]), P(box(0.16, 0.02, 0.03), '#e8ecf4', [-0.15, 0.1, -0.03], [0, 0, -0.35]),
    P(box(0.5, 0.04, 0.04), '#5a4030', [0, 0.04, 0]), P(box(0.04, 0.34, 0.04), '#5a4030', [-0.12, 0.2, 0.08], [0.3, 0, 0.2]), P(box(0.04, 0.34, 0.04), '#5a4030', [-0.12, 0.2, -0.08], [-0.3, 0, 0.2]),
    P(sph(0.045, 6), [3.0, 1.6, 0.3], [-0.26, 0.02, 0]), P(sph(0.028, 5), [3.0, 2.4, 0.9], [-0.29, 0.06, 0])]);
  return {
    rocket: { geo: rocket, mat: PAINT, ring: new THREE.Color('#ff7a2a') },
